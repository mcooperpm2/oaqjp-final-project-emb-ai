...
def emotion_detector(text_to_analyze): #Defining a function named emotion_detector to take a string input (text to analyze)
    ...
    emotions = formatted_response['emotionPredictions'][0]['emotion'] #Extract the emotion dictionary from the API response
    ...
    } #Return a dictionary containing emotion scores and dominant emotion